"""
Service d'interprétation IA avec OpenAI - Compatible Python 3.6
"""
import openai
import os
import json
...
MODEL = os.environ.get('OPENAI_MODEL', 'gpt-3.5-turbo')  # gpt-4o-mini pas dispo sur API 0.28
...
Sois toujours positif, inspirant et encourage l'introspection."""
    ...
    try:
        # API OpenAI 0.28.x (compatible Python 3.6)
        ...
        return {
            ...
            "spiritual_message": content[:200] if 'content' in locals() and content else "L'univers t'envoie un message à travers ce rêve.",
...
"""
    ...
    try:
        ...
        return {
            ...
            "spiritual_message": content[:200] if 'content' in locals() and content else "L'univers communique avec toi à travers ce signe.",
...
Ton doit être mystique, poétique et rassurant. Crée une histoire avec les 3 cartes."""
    ...
    try:
        ...
        return {
            ...
            "spiritual_message": content[:200] if 'content' in locals() and content else "Ton âme connaît déjà les réponses.",
